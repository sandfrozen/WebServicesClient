...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws/", "getServerNameResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getServerNameResponse")
